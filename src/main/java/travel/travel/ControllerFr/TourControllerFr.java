package travel.travel.ControllerFr;
...
@RequestMapping("/api/toursFr")
@Slf4j
@RequiredArgsConstructor
public class TourControllerFr {
    ...
    public ResponseEntity<SimpleResponse> saveTour(@RequestBody TourRequest tourRequest) {
        SimpleResponse simpleResponse = tourService.saveTourFr(tourRequest);
    ...
    public ResponseEntity<TourResponseGetByID> getById(@PathVariable Long id) {
        TourResponseGetByID tourById = tourService.getTourByIdFr(id);
    ...
    public SimpleResponse updateTour(@PathVariable Long id,
        ...
        return tourService.updateTourFr(id, tourRequest);
    }
}