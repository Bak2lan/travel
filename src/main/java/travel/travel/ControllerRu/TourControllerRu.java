package travel.travel.ControllerRu;
...
@RequestMapping("/api/toursRu")
@Slf4j
@RequiredArgsConstructor
public class TourControllerRu {
    ...
    public ResponseEntity<SimpleResponse> saveTour(@RequestBody TourRequest tourRequest) {
        SimpleResponse simpleResponse = tourService.saveTourRu(tourRequest);
    ...
    public ResponseEntity<TourResponseGetByID> getById(@PathVariable Long id) {
        TourResponseGetByID tourById = tourService.getTourByIdRu(id);
    ...
    public SimpleResponse updateTour(@PathVariable Long id,
        ...
        return tourService.updateTourRu(id, tourRequest);
    }
