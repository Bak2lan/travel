...
-- values (1, 'Welcome to our travel agency!', 'contact@travel.com', 'All documents are verified.', 'We prioritize sustainability in tourism.');
--
-- INSERT INTO categories (id, day, day_tour, travel_id)
-- VALUES
--     (1, 2025-01-01, 'Day tour example 1', 1),
...
--
-- INSERT INTO sights (id, latitude, longitude, description, name_of_sight, about_kyrgyzstan_id, travel_id)
-- VALUES
--     (1, 42.567, 74.352, 'Ala-Archa National Park', 'Ala-Archa', NULL, 1),
--     (2, 41.841, 75.131, 'Son-Kul Lake', 'Son-Kul', NULL, 1),
--     (3, 42.720, 75.891, 'Burana Tower', 'Burana Tower', NULL, 1),
--     (4, 40.528, 72.805, 'Suleiman Mountain', 'Suleiman Mountain', NULL, 1),
--     (5, 42.484, 78.395, 'Karakol Valley', 'Karakol', NULL, 1);
--
-- INSERT INTO about_kyrgyzstan (id, description, name, video_file, sight_id)
-- VALUES
--     (1, 'Kyrgyzstan is known for its beautiful mountains and cultural heritage.', 'Explore Kyrgyzstan', 'intro.mp4', 1),
...
--     (3, 42.720, 75.891, 'Discover Burana Tower', '2025-03-01', '2025-03-03', 3, 10, 2, 80.0, 'Burana Tower Tour', 3, 3, 1),
--     (4, 40.528, 72.805, 'Sacred Suleiman Mountain', '2025-04-01', '2025-04-02', 2, 15, 1, 50.0, 'Suleiman Mountain Visit', 4, 4, 1),
--     (5, 42.484, 78.395, 'Karakol Nature Retreat', '2025-05-01', '2025-05-06', 6, 12, 5, 300.0, 'Karakol Nature Tour', 5, 5, 1);
--
...
-- VALUES
--     (1, 'Comfortable accommodation', 'accommodation'),
...
INSERT INTO travels (id, about_us, contact, documentation, sustainability)
VALUES
    (1, 'Welcome to our travel agency!', 'contact@travel.com', 'All documents are verified.', 'We prioritize sustainability in tourism.');
...
SELECT setval('travels_id_seq', (SELECT MAX(id) FROM travels));
SELECT setval('categories_id_seq', (SELECT MAX(id) FROM categories));
SELECT setval('sights_id_seq', (SELECT MAX(id) FROM sights));
SELECT setval('about_kyrgyzstan_id_seq', (SELECT MAX(id) FROM about_kyrgyzstan));
