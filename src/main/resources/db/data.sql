...
INSERT INTO tours_details (id, tours_detail_name, days, distance, about_tour_details)
VALUES
    (1, 'Тянь-Шань экспедициясы деталдары', '7 күн', '500 км', 'Тянь-Шандын кооз тоолору боюнча экскурсия'),
    (2, 'Ысык-Көлдүн жээгиндеги тур', '5 күн', '300 км', 'Ысык-Көлдүн жээгинде эс алуу жана экскурсиялар'),
    (3, 'Көл-Сууга саякат', '3 күн', '250 км', 'Көл-Суу көлүнө унаа жана жөө саякат'),
    (4, 'Ала-Арчада сейилдөө', '1 күн', '20 км', 'Ала-Арча паркындагы жөө сейилдөө'),
    (5, 'Ош базарына экскурсия деталдары', '1 күн', '10 км', 'Ош базарына экскурсия, жергиликтүү тамактар жана сувенирлер'),
    (6, 'Таш-Рабат тарыхый саякаты деталдары', '2 күн', '200 км', 'Таш-Рабат кербен сарайына экскурсия'),
    (7, 'Жети-Өгүзгө жөө жүрүш деталдары', '2 күн', '40 км', 'Жети-Өгүз капчыгайында жөө саякат'),
    (8, 'Барскоон шаркыратмасына тур деталдары', '1 күн', '15 км', 'Барскоон шаркыратмасына жөө саякат жана жаратылышты көрүү'),
    (9, 'Саймалуу-Ташка экспедиция деталдары', '3 күн', '250 км', 'Саймалуу-Таштагы байыркы сүрөттөргө экскурсия'),
    (10, 'Сулуу-Тоо саякаты деталдары', '2 күн', '100 км', 'Сулуу-Тоо аймагындагы кооз тоолорду изилдөө');


INSERT INTO tours (id, travel_id, tour_details_id, tour_name, about_tour, days, nights, price, pax, date_from, date_to, value_category, popular, coordinates_image)
VALUES (1, 1, 1,'Тянь-Шань экспедициясы', 'Бул саякат Кыргызстандын эң кооз тоолорун кыдырууга арналган. Саякатчылар жаратылыштын сулуулугунан ырахат ала алышат.', 7, 6, 500, '5-10 адам', '2025-06-01', '2025-06-07', 'Тоолор', true, '42.5000, 78.5000'),
       (2, 1, 2,'Ысык-Көлдүн жээги', 'Бул тур Ысык-Көлдүн кооз жээгинде эс алуу үчүн уюштурулган. Көлдүн жылуу суусунда сүзүп, жаратылыштан ырахат аласыз.', 5, 4, 300, '10-15 адам', '2025-07-10', '2025-07-15', 'Көл', false, '42.3400, 77.0800'),
       (3, 1,3, 'Көл-Сууга саякат', 'Бул тур сизди Нарын облусунун эң кооз көлдөрүнүн бирине алып барат.', 3, 2, 250, '4-8 адам', '2025-08-01', '2025-08-03', 'Тоолор', true, '40.6733, 76.4871'),
       (4, 1, 4,'Ала-Арчада сейилдөө', 'Бул тур Ала-Арча паркында сейилдеп, таза абадан ырахат алуу үчүн.', 1, 0, 50, '5-15 адам', '2025-05-15', '2025-05-15', 'Жаратылыш', false, '42.5543, 74.4860'),
       (5, 1, 5,'Ош базарына экскурсия', 'Ош базарын кыдырып, жергиликтүү тамактарды жана сувенирлерди сатып алууга мүмкүнчүлүк берет.', 1, 0, 30, '5-10 адам', '2025-06-10', '2025-06-10', 'Шаар', false, '42.8746, 74.5921'),
       (6, 1, 6,'Таш-Рабат тарыхый саякаты', 'Бул саякат Таш-Рабат кербен сарайына багытталган.', 2, 1, 200, '6-12 адам', '2025-07-05', '2025-07-07', 'Тарых', true, '40.8341, 75.2800'),
       (7, 1,7, 'Жети-Өгүзгө жөө жүрүш', 'Жети-Өгүздүн кооз капчыгайына жөө саякат.', 2, 1, 150, '4-10 адам', '2025-07-15', '2025-07-17', 'Жаратылыш', true, '42.1820, 77.2020'),
       (8, 2,8, 'Барскоон шаркыратмасына тур', 'Барскоон шаркыратмасына жөө саякат жана жаратылышты көрүү.', 1, 0, 40, '5-12 адам', '2025-06-20', '2025-06-20', 'Шаркыратма', false, '42.0895, 77.5993'),
       (9, 2,9, 'Саймалуу-Ташка экспедиция', 'Саймалуу-Таштагы байыркы сүрөттөрдү көрүүгө мүмкүнчүлүк.', 3, 2, 300, '5-8 адам', '2025-08-10', '2025-08-12', 'Тарых', true, '41.7417, 74.9389'),
       (10, 2,10, 'Сулуу-Тоо саякаты', 'Сулуу-Тоо аймагындагы кооз тоолорду изилдөө.', 2, 1, 180, '6-10 адам', '2025-09-01', '2025-09-03', 'Жаратылыш', false, '41.3500, 75.8900');
